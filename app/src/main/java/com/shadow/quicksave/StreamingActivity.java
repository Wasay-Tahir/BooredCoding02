...
public class StreamingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Stream Video");
            ...
            return YoutubeDL.getInstance().getInfo(request);
                ...
                .subscribe(streamInfo -> {
                    ...
                    if (TextUtils.isEmpty(videoUrl)) {
                        ...
                        Toasty.error(StreamingActivity.this, "Failed to get stream url").show();
                    } else {
                    ...
                    Toasty.error(StreamingActivity.this, "Streaming failed. failed to get stream info").show();
                });
    ...
    private void clearInput() {
        if (etUrl.getText().toString().isEmpty()) {
            Toasty.info(StreamingActivity.this, "The input is already empty!", Toast.LENGTH_SHORT, true).show();
        } else {
            etUrl.setText("");
